...
<head>
  ...
  <title>WD CARS <?php echo $hlm ?></title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url()?>NiceAdmin/assets/img/logo-car.svg" rel="icon">
  <link href="<?= base_url()?>NiceAdmin/assets/img/logo-car.svg" rel="apple-touch-icon">
